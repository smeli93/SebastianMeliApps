<%-- 
    ...
    Author     : PC
--%>
<jsp:useBean id="lista" class="daoImpl.RazaDAOImp"/>
<jsp:useBean id="lista2" class="daoImpl.TipoMascotaDAOImp"/>
        ...
        <div class="wrapper row0">
            <div id="topbar" class="hoc clear"> 
                ...
                <div class="fl_left">
                 ...
                 <div class="fl_right">
                     <ul>
                         <li>Bienvenido: ${dto.nombreUsuario} ${dto.apellidoUsuario}</li>
                         <li>
            ...
            <header id="header" class="hoc clear"> 
                <div id="logo" class="fl_left">
                    <table style="border:hidden;">
                        <tr>
                            <td style="border:hidden;"><a href="../index.jsp"><img src="/Veterinaria/resources/images/logo.png" alt="" width="20" height="15"/></a></td>
                    ...
                    <li><a href="#"> &nbsp; </a></li>                    
                        ...
                        <li><a class="drop" href="#">Administrador</a>
                            <ul>
                                ...
                                <li><a href="/Veterinaria/Veterinario/listaVeterinario.jsp">Adm. Veterinarios</a></li>
                                <li><a href="vEspecialidad/listaEspecialidad.jsp">Adm. Especialidades</a></li>
            ...
            <main class="hoc container clear"> 
                ...
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <form action="/Veterinaria/CrearMascota" method="POST">
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="txtNombre" value="" placeholder="Ingrese Nombre" required weight="500"/></td>
                                </tr>
                                <tr>
                                    <td>Fecha Nacimiento</td>
                                    <td><input type="date" name="txtFechaNacimiento" value="" placeholder="Ingrese Fecha" required/></td>
                                </tr>
                                <tr>
                                    <td>Dueño</td>
                                    <td><input type="text" name="txtDueno" value="" placeholder="Ingrese Rut dueño" required/></td>
                                </tr>
                                <tr>
                                    <td>Tipo Mascota</td>
                                    <td><select name="cmbTipo" required>
                                            <c:forEach  var="tipo" items="${lista2.listarNombreTipoMascota()}">
                                                <b><option><c:out value="${tipo}" /></option></b>
                                            </c:forEach>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Raza</td>
                                    <td><select name="cmbRaza" required>
                                            <c:forEach  var="razas" items="${lista.listarNombreRaza()}">
                                                <b><option><c:out value="${razas}" /></option></b>
                                            </c:forEach>
                                        </select>
                                    </td>
                                </tr>
                            ...
                            <br>
                            <br>
                            <input type="submit" class="btn" value="REGISTRAR" name="btnEnviar" required/>

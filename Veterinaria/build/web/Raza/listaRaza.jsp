    ...
    <c:if test="${mensaje!=null}">
        ...
        <div class="wrapper row3" align="center">
            <main class="hoc container clear"> 
                <!-- main body -->
                &nbsp;<input type="submit" class="btn" onclick="location.href = '/Veterinaria/Raza/crearRaza.jsp'" value="+ nuevo"/>
                <br>
                </br>
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <table border="1">
                            ...
                            <jsp:useBean class="daoImpl.RazaDAOImp" id="razaDAO"></jsp:useBean>
                            <c:forEach items="${razaDAO.listarRaza()}" var="raza">
                                <tr>
                                    <td align="center">${raza.idRaza}</td>
                                    <td align="center">${raza.descripcionRaza}</td>
                                    <td align="center">
                                        <form id="especialidad" action="/Veterinaria/EliminarRaza" method="POST">
                                            <input type="hidden" name="btnEliminar" value="${raza.idRaza}"/> 

            ...
            <main class="hoc container clear"> 
                ...
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <form action="/Veterinaria/CrearPerfil" method="POST">

                            <table border="0" align="center">
                                <tbody>

                                    <tr>
                                        <td align="center"><label>Nombre Perfil</label></td>
                                        <td><input size="30" type="text"name="txtPerfil" value="" placeholder="Nombre de Perfil" required/></td>
                                    </tr>
                                </tbody>
                            </table>
                            <br>

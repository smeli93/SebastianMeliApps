    ...
    <c:if test="${mensaje!=null}">
        ...
        <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
            <section id="breadcrumb" class="hoc clear"> 
                <h1><b>Lista de Veterinarios</b></h1>
            </section>
        </div>
        <div class="wrapper row3" align="center">
            <main class="hoc container clear"> 
                <!-- main body -->
                &nbsp;<input type="submit" class="btn" onclick="location.href = '/Veterinaria/Veterinario/crearVeterinario.jsp'" value="+ nuevo"/>
                <br>
                </br>
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <table border="1">
                            ...
                            <jsp:useBean class="daoImpl.VeterinarioDAOImp" id="vetDAO"></jsp:useBean>
                            <c:forEach items="${vetDAO.listarVeterinarios()}" var="vet">
                                <tr>
                                    ...
                                    <td>${vet.direccion}</td>
                                    <td>${vet.telefono}</td>
                                    <td>${vet.fechaDeIngreso}</td>
                                    <td>${vet.idEspecialidad}</td>
                                    <td>
                                        <form id="veterinario" action="/Veterinaria/EliminarVeterinario" method="POST">
                                            <input type="hidden" name="btnEliminar" value="${vet.idVeterinario}"> 

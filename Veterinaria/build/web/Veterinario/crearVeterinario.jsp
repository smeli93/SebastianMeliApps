<%-- 
    ...
    Created on : 03-dic-2016, 10:52:51
    Author     : Meli
<%-- 
...
<jsp:useBean id="lista" class="daoImpl.EspecialidadDAOImp"/>
<%@page session="true" %>
<%@ taglib prefix="c" 
...
<html xmlns="http://www.w3.org/1999/xhtml"
                ...
                <ul class="nospace inline">
                    ...
                    <table style="border:hidden;">
                        <tr>
                            ...
                            %>                               
                            <td style="border:hidden;"><a class="btn" href="#" ><b>Reserva de Horas</b></a></td>
                            <%
                                    }
                                }
                            %>
    ...
    <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
        <section id="breadcrumb" class="hoc clear"> 
            <h1><b>Registro Veterinario</b></h1>
        </section>
    </div>
        ...
        <main class="hoc container clear"> 
            ...
            <div class="content" align="center"> 
                ...
                <div class="scrollable" align="center">
                    <form action="/Veterinaria/CrearVeterinario" method="POST">
                        <table border="0" align="center">

                            <tbody align="center">
                            <tr>
                                <td>Nombre</td>
                                <td><input style="width: 300px; height: 30px; text-align-last:center;" type="text" name="txtNombre" value="" placeholder="Ingrese Nombre" required/></td>
                            </tr>
                            <tr>
                                <td>Apellido</td>
                                <td><input style="width: 300px; height: 30px; text-align-last:center;" type="text" name="txtApellido" value="" placeholder="Ingrese Apellido" required/></td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td><input style="width: 300px; height: 30px; text-align-last:center;" type="text" name="txtEmail" value="" placeholder="Ingrese Email" required/></td>
                            </tr>
                            <tr>
                                <td>Direccion</td>
                                <td><input style="width: 300px; height: 30px; text-align-last:center;" type="text" name="txtDireccion" value="" placeholder="Ingrese direccion" required/></td>
                            </tr>
                            <tr>
                                <td>Telefono</td>
                                <td><input style="width: 300px; height: 30px; text-align-last:center;" type="text" name="txtTelefono" value="" placeholder="Ingrese Numero Telefono" required/></td>
                            </tr>
                            <tr>
                                <td>Fecha Ingreso</td>
                                <td><input style="width: 300px; height: 30px; text-align-last:center;" type="date" name="txtFechaIngreso" value="" placeholder="Ingrese Fecha" required/></td>
                            </tr>
                            <tr>
                                <td>Especialidad</td>
                                <td><select style="width: 300px; height: 30px; text-align-last:center;" name="cmbEspecialidad" required>
                                        <c:forEach  var="especialidad" items="${lista.listarEspecialidad()}">
                                            <b><option><c:out value="${especialidad}" /></option></b>
                                        </c:forEach>
                                    </select>
                                </td>
                            </tr>
                        ...
                        <br>
                        <br>
                        <input type="submit" style="width: 300px; text-align-last:center;" class="btn" value="REGISTRAR" name="btnEnviar"/>

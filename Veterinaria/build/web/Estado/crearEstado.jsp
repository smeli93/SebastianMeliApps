            ...
            <main class="hoc container clear"> 
                ...
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <form action="/Veterinaria/CrearEstado" method="POST">

                            <table border="0" style="border:hidden;">
                                <tbody>

                                    <tr>
                                        <td style="border:hidden;" align="right"><label>Nombre Estado</label></td>
                                        <td align="center"><input type="text" size="50" name="txtEstado" value="" placeholder="Nombre del Estado" required/></td>
                                    </tr>
                                </tbody>
                            </table>
                                <br>

        ...
        <main class="hoc container clear"> 
            ...
            <div class="content" align="center"> 
                ...
                <div class="scrollable" align="center">
                    <form action="/Veterinaria/CrearUsuarioAdmin" method="POST">
                        <table border="0">
                            ...
                            <tr>
                                <td>Contraseña</td>
                                <td><input title="La contraseña debe ser mínimo de 6 carácteres, incluyendo MAYÚSCULAS/minusculas y números"
                                           type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
                                           name="password" placeholder="Clave" 
                                           onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');
                                                   if (this.checkValidity())
                                                       form.confPassword.pattern = this.value;"required/></td>
                            </tr>
                            <tr>
                                <td>Confirme Contraseña</td>
                                <td><input title="Las contraseñas no coinciden..."
                                           type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" 
                                           name="confPassword" 
                                           onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');"
                                           placeholder="Confirmar Clave" required/></td>
                            </tr>
                            <tr>
                                <td>Nombre</td>
                            ...
                            <tr>
                                <td>Apellido</td>
                                <td><input type="text" name="txtApellido" value="" placeholder="Ingrese Apellido" required/></td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td><input type="text" name="txtEmail" value="" placeholder="Ingrese Email" required/></td>
                            </tr>
                            <tr>
                                <td>Telefono</td>
                                <td><input type="text" name="txtTelefono" value="" placeholder="Ingrese Numero Telefono" required/></td>
                            </tr>
                            <tr>
                                <td>Perfil</td>
                                <td><select name="cmbPerfil" required>
                                        <c:forEach  var="perfil" items="${lista.listarNombrePerfil()}">
                                            <b><option><c:out value="${perfil}" /></option></b>
                                        </c:forEach>
                                    </select>
                                </td>
                            </tr>
                        ...
                        <br>
                        <br>
                        <input type="submit" class="btn" value="REGISTRAR" name="btnEnviar"/>

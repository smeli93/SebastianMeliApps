...
<%-- 
    ...
    Author     : PC
--%>
<jsp:useBean id="lista" class="daoImpl.PerfilDAOImp"/>
...
<html xmlns="http://www.w3.org/1999/xhtml"
        ...
        <header id="header" class="hoc clear"> 
            <div id="logo" class="fl_left">
                <table style="border:hidden;">
                    <tr>
                        <td style="border:hidden;"><a href="/Veterinaria/index.jsp"><img src="../resources/images/logo.png" alt="" width="20" height="15"/></a></td>
    ...
    <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
        <section id="breadcrumb" class="hoc clear"> 
            <h1 align="center"><b>Registrarse</b></h1>
        </section>
    </div>
    <div class="wrapper row3" align="center">
        <main class="hoc container clear">  
            <div class="content" align="center"> 
                    <form action="/Veterinaria/CrearUsuario" method="POST">
                                <input style="width: 300px; height: 40px; text-align: center;" type="text" name="txtRut" value="" placeholder="Ingrese Rut" required/><br>
                                <input style="width: 300px; height: 40px; text-align: center;"title="La contraseña debe ser mínimo de 6 carácteres, incluyendo MAYÚSCULAS/minusculas y números"
                                               type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
                                               name="password" placeholder="Clave" 
                                               onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');
                                                   if (this.checkValidity())
                                                       form.confPassword.pattern = this.value;"required/><br>
                                <input style="width: 300px; height: 40px; text-align: center;" title="Las contraseñas no coinciden..."
                                               type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" 
                                               name="confPassword" 
                                               onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');"
                                               placeholder="Confirmar Clave" required/><br>
                                <input style="width: 300px; height: 40px; text-align: center;" type="text" name="txtNombre" value="" placeholder="Ingrese Nombre" required/><br>
                                <input style="width: 300px; height: 40px; text-align: center;" type="text" name="txtApellido" value="" placeholder="Ingrese Apellido" required/><br>
                                <input style="width: 300px; height: 40px; text-align: center;" type="text" name="txtEmail" value="" placeholder="Ingrese Email" required/><br>
                                <input style="width: 300px; height: 40px; text-align: center;" type="text" name="txtTelefono" value="" placeholder="Telefono" required/>
                                <br>
                                <input style="width: 300px; height: 40px;" type="submit" class="btn" value="REGISTRAR" name="btnEnviar""/>
                    </form>
            </div>

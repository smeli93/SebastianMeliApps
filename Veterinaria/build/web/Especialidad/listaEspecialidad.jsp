...
<!-- informacion superior -->
        ...
        <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
            <section id="breadcrumb" class="hoc clear"> 
                <h1><b>Lista Especialidades</b></h1>
            </section>
        </div>
        <div class="wrapper row3" align="center">
            <main class="hoc container clear"> 
                <!-- main body -->
                &nbsp;<input type="submit" class="btn" onclick="location.href='/Veterinaria/Especialidad/crearEspecialidad.jsp'" value="+ nuevo"/>
                <br>
                </br>
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <table border="1">
                            ...
                            <jsp:useBean class="daoImpl.EspecialidadDAOImp" id="especialidadDAO"></jsp:useBean>
                            <c:forEach items="${especialidadDAO.listarEspecialidades()}" var="especialidad">
                    
                            <tr >
                                <td align="center">${especialidad.idEspecialidad}</td>
                                <td align="center">${especialidad.descripcionEspecialidad}</td>
                                <td align="center">
                                    <form id="especialidad" action="/Veterinaria/EliminarEspecialidad" method="POST">
                                        <input type="hidden" name="btnEliminar" value="${especialidad.idEspecialidad}"> 

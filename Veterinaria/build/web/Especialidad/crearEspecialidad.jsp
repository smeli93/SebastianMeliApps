            ...
            <main class="hoc container clear"> 
                ...
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <form action="/Veterinaria/CrearEspecialidad" method="POST">

                            <table border="0" style="border:hidden;" >
                                <tbody>

                                    <tr>
                                        <td align="center" style="border:hidden;"><label>Nombre Especialidad</label></td>
                                        <td><input type="text" size="50" name="txtNombreEsp" value="" placeholder="Nombre de la especialidad" required/></td>
                                    </tr>
                                </tbody>
                            </table>
                            <br>

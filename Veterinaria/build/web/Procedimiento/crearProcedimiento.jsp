...
<jsp:useBean id="lista2" class="daoImpl.ReservaDAOImp"/>
<%@ taglib prefix="c" 
...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        ...
        <title>Crear Procedimiento Médico</title>
        <meta charset="utf-8"/>
    ...
    <!-- informacion superior -->
        ...
        <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
            <section id="breadcrumb" class="hoc clear"> 
                <h1><b>Registrar Nuevo Procedimiento Medico</b></h1>
            </section>
        </div>
        ...
        <%
            Reserva dto2 = (Reserva) session.getAttribute("dto2");
            if (session.getAttribute("dto2") != null) {
        %>

        <form action="/Veterinaria/CrearProcedimiento" method="POST">
            <table border="0">
                ...
                <tr>
                    <td align="right">Nombre Procedimiento</td>
                    <td><input type="text" name="txtNombrePro" value="" placeholder="Ingrese el procedimiento" required/></td>
                </tr>
                <tr>
                    <td align="right">Fecha</td>
                    <td><input type="date" name="txtFechaPro" value="" placeholder="Ingrese la Fecha" required/></td>
                </tr>
                <tr>
                    <td align="right">Descripción</td>
                    <td><input type="text" name="txtDescripcion" value="" placeholder="Ingrese una Descripcion" required/></td>
                </tr>
                <tr>
                    <td align="right"></td>
                    <td><input type="hidden" name="txtReserva" value="<%=dto2.getIdReserva()%>" readonly/></td>
                </tr>
                <tr>
                    <td align="right"></td>
                    <td><input type="hidden" name="txtMascota" value="<%=dto2.getMascotaidMascota()%>" readonly/></td>
                </tr>
                </tbody>
            </table>
            <br>

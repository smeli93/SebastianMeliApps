...
<%-- 
    ...
    Author     : PC
--%>
<%@page import="dto.Procedimiento"%>
<%@page import="daoImpl.ProcedimientoDAOImp"%>
                    ...
                    <div class="scrollable" align="center">
                        ...
                        <table>
                            ...
                            <tbody align="center">
                                ...
                                <tr align="center">
                                    <td><%= dto.getIdProcedimiento()%></td>
                                    <td><%= dto.getNombreProdecimiento()%></td>
                                    <td><%= dto.getFechaProcedimiento()%></td>
                                    <td><%= dto.getDescripcionProcedimiento()%></td>
                                    <td><%= dto.getReservaidReserva()%></td>
                        ...
                        <% } else {%>
                        No hay procedimientos asociados a la mascota
                        <% }%>
                    </div>

    ...
    <c:if test="${mensaje!=null}">
        ...
        <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
            <section id="breadcrumb" class="hoc clear"> 
                <h1><b>Listado de Procedimientos</b></h1>
            </section>
        </div>
                ...
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <table border="1">
                            ...
                            <jsp:useBean class="daoImpl.ProcedimientoDAOImp" id="proDAO"></jsp:useBean>
                            <c:forEach items="${proDAO.listarProcedimientos()}" var="pro">
                                <tr align="center">
                                    <td>${pro.idProcedimiento}</td>
                                    <td>${pro.nombreProdecimiento}</td>
                                    <td>${pro.fechaProcedimiento}</td>
                                    <td>${pro.descripcionProcedimiento}</td>
                                    <td>${pro.reservaidReserva}</td>
                                    <td>${pro.mascotaidMascota}</td>
                                    <td>
                                        <form id="veterinario" action="/Veterinaria/EliminarProcedimiento" method="POST">
                                            <input type="hidden" name="btnEliminar" value="${pro.idProcedimiento}"> 

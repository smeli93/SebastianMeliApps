...
public final class listaReserva_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Lista de Horas Medicas</title>\n");
      ...
      out.write("                        <ul>\n");
      out.write("                            <li><a href=\"../Usuario/PerfilUsuario.jsp\">Mi Perfil</a></li>\n");
      ...
      out.write("                <h1><b>Reservas de horas Médicas</b></h1>\n");
      out.write("            </section>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"wrapper row3\" align=\"center\">\n");
      out.write("            <main class=\"hoc container clear\"> \n");
      out.write("                <!-- main body -->\n");
      out.write("                &nbsp;<input type=\"submit\" class=\"btn\" onclick=\"location.href = '../Reserva/crearReserva.jsp'\" value=\"+ nueva Reserva\"/>\n");
      out.write("                <br>\n");
      out.write("                </br>\n");
      ...
      out.write("                            </tr>\n");
      out.write("                            ");
      daoImpl.ReservaDAOImp resDAO = null;
      synchronized (_jspx_page_context) {
        resDAO = (daoImpl.ReservaDAOImp) _jspx_page_context.getAttribute("resDAO", PageContext.PAGE_SCOPE);
        if (resDAO == null){
          resDAO = new daoImpl.ReservaDAOImp();
      ...
      _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${resDAO.listarReservas()}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
      ...
      try {
        ...
        if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("                                <tr>\n");
            out.write("                                    <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${res.idReserva}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("                                    <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${res.motivoReserva}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("                                    <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${res.fechaReserva}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("                                    <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${res.horaReserva}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("                                    <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${res.estadoidEstado}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("                                    <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${res.veterinarioidVeterinario}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("                                    <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${res.usuariorutusuario}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("                                    <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${res.mascotaidMascota}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("                                                                    ");
            ...
            out.write("\n");
            out.write("                                    <td>\n");
            out.write("                                        <form id=\"veterinario\" action=\"/Veterinaria/EliminarReserva\" method=\"POST\">\n");
            ...
            out.write("                                        </form>\n");
            out.write("\n");
            out.write("                                        <form id=\"Reserva\" action=\"/Veterinaria/BuscarReservaId\" method=\"POST\">\n");
            out.write("                                            <input type=\"hidden\" name=\"txtMascota2\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${res.mascotaidMascota}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("\"> \n");
            out.write("                                            <input type=\"hidden\" name=\"txtId2\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${res.idReserva}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("\"> \n");
            out.write("                                            <input name=\"btnEnviar\" type=\"submit\" value=\"Crear Procedimiento\">\n");
            out.write("                                        </form> \n");
            out.write("                                    </td>\n");
            out.write("                                ");

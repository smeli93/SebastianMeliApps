...
public class CrearEspecialidad extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            dto.setDescripcionEspecialidad(request.getParameter("txtNombreEsp".trim()));
            
            if (new EspecialidadDAOImp().registrar(dto)) {
                    request.setAttribute("mensaje", "Especialidad Registrada");                   
                } else {
                    request.setAttribute("mensaje", "No se puede Registrar...");
                }
            request.getRequestDispatcher("Especialidad/crearEspecialidad.jsp").forward(request, response);
        }
    }

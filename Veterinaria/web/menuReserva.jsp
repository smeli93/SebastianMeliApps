...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        ...
        <title>Menu Reserva de Horas</title>
        <meta charset="utf-8"/>
...
<!-- informacion superior -->
        ...
        <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
            <section id="breadcrumb" class="hoc clear"> 
                <h1 align="center"><b>Menú Reserva</b></h1>
            </section>
        </div>
            ...
            <main class="hoc container clear">  
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <input style="width: 220px; height: 90px;" type="submit" class="btn" onclick="location.href='Reserva/crearReserva.jsp'" value="Agendar Hora" name="btnEnviar"/>&nbsp;
                        <input style="width: 220px; height: 90px;" type="submit" class="btn" onclick="location.href = 'Reserva/buscarReservaVeterinario.jsp'" value="Buscar Veterinario" name="btnEnviar"/>&nbsp;
                        <input style="width: 220px; height: 90px;" type="submit" class="btn" onclick="location.href = 'Reserva/buscarReservaFecha.jsp'" value="Buscar Por Fecha" name="btnEnviar" />&nbsp;
                        <input style="width: 220px; height: 90px;" type="submit" class="btn" onclick="location.href='Reserva/listaReserva.jsp'" value="Horas Reservadas" name="btnEnviar"/>
                    </div>
                    <br>
                    <br>
                    <br>

            ...
            <div id="topbar" class="hoc clear"> 
                ...
                <div class="fl_right">
                    <ul>
                        ...
                        <li><a href="../Usuario/crearUsuario.jsp">Registrarse</a></li>
                    </ul>
                </div>
                <%
                    }
                ...
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <table border="1" align="">
                            ...
                            <jsp:useBean class="daoImpl.MascotaDAOImp" id="masDAO"></jsp:useBean>
                            <c:forEach items="${masDAO.listarMascotas()}" var="mas">
                                <tr align="center">
                                    <td>${mas.idMascota}</td>
                                    <td>${mas.nombreMascota}</td>
                                    <td>${mas.fechaNacimiento}</td>
                                    <td>${mas.usuariorutusuario}</td>
                                    <td>${mas.tipoMascotaidTipoMascota}</td>
                                    <td>${mas.razaidRaza}</td>

                                    <td>
                                        <form id="veterinario" action="/Veterinaria/EliminarMascota" method="POST">
                                            <input type="hidden" name="btnEliminar" value="${mas.idMascota}"> 
                                                <input name="btnEnviar" type="submit" value="Eliminar"/>
                                        </form>
                                    </td>                                   
                                    <td>
                                        <form id="" action="/Veterinaria/BuscarProcedimientosMascota" method="POST">
                                            <input type="hidden" name="txtMascota" value="${mas.idMascota}"/>
                                            <input name="btnActualizar" type="submit" value="Historial"/>
                                        </form>
                                    </td>
                                </tr>                   
                            </c:forEach>

...
<%-- 
    ...
    Author     : PC
--%>
<%@page import="dto.Mascota"%>
<%@page import="daoImpl.MascotaDAOImp"%>
    ...
    <body>
        ...
        <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
            <section id="breadcrumb" class="hoc clear"> 
                <h1><b>Mis Mascotas</b></h1>
            </section>
        </div>
        <div class="wrapper row3" align="center">
            <main class="hoc container clear"> 
                <!-- main body -->
                &nbsp;<input type="submit" class="btn" onclick="location.href = '/Veterinaria/Mascota/crearMascota.jsp'" value="+ nuevo"/>
                <br>
                </br>
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        ...
                        <table align="center">
                            <thead>
                                <tr>
                                    <th><font face="arial">Id</th>
                                    <th><font face="arial">Nombre</th>
                                    <th><font face="arial">fecha Nacimiento</th>
                                    <th><font face="arial">Id Raza</th>
                                    <th><font face="arial">Id Tipo Mascota</th>
                                    <th><font face="arial">Acción</th>
                            ...
                            <tbody align="center">
                                ...
                                <tr>
                                    <td><%= dto.getIdMascota()%></td>
                                    <td><%= dto.getNombreMascota()%></td>
                                    <td><%= dto.getFechaNacimiento()%></td>
                                    <td><%= dto.getRazaidRaza()%></td>
                                    <td><%= dto.getTipoMascotaidTipoMascota()%></td>
                                    <td><form id="" action="/Veterinaria/BuscarProcedimientosMascota" method="POST">
                                            <input type="hidden" name="txtMascota" value="<%= dto.getIdMascota()%>"/>
                                            <input name="btnActualizar"  class="btn2"type="submit" value="Historial"/>
                                        </form>
                                    </td>
                                </tr>
                                <% } %>
                        ...
                        <% } else {%>
                        No posee mascotas registradas en el sistema
                        <% }%>
                    </div>

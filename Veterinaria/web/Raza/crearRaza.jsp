            ...
            <main class="hoc container clear"> 
                ...
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <form action="/Veterinaria/CrearRaza" method="POST">

                            <table border="0">
                                <tbody>

                                    <tr>
                                        <td align="right"><label>Nombre Raza</label></td>
                                        <td><input type="text" name="txtRaza" value="" placeholder="Raza de la Mascota" required/></td>
                                    </tr>
                                </tbody>
                            </table>
                            <br>

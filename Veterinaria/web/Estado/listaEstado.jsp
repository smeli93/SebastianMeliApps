...
<body>
    ...
    <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
        <section id="breadcrumb" class="hoc clear"> 
            <h1><b>Lista Estados</b></h1>
        </section>
    </div>
    <div class="wrapper row3" align="center">
        <main class="hoc container clear"> 
            <!-- main body -->
            &nbsp;<input type="submit" class="btn" onclick="location.href = '/Veterinaria/Estado/crearEstado.jsp'" value="+ nuevo"/>
            <br>
            </br>
            <div class="content" align="center"> 
                ...
                <div class="scrollable" align="center">
                    <table border="1">
                        ...
                        <jsp:useBean class="daoImpl.EstadoDAOImp" id="estadoDAO"></jsp:useBean>
                        <c:forEach items="${estadoDAO.listarEstados()}" var="estado">
                            <tr>
                                <td align="center">${estado.idEstado}</td>
                                <td align="center">${estado.descripcionEstado}</td>
                                <td align="center">
                                    <form id="especialidad" action="/Veterinaria/EliminarEstado" method="POST">
                                        <input type="hidden" name="btnEliminar" value="${estado.idEstado}"/>         
    ...
    <!-- JAVASCRIPTS -->
    <script src="/Veterinaria/resources/layout/scripts/jquery.min.js"/>
    <script src="/Veterinaria/resources/layout/scripts/jquery.backtotop.js"/>
    <script src="/Veterinaria/resources/layout/scripts/jquery.mobilemenu.js"/>
    <script src="/Veterinaria/resources/layout/scripts/jquery.flexslider-min.js"/>
</body>

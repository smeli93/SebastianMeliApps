...
<!-- informacion superior -->
        ...
        <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
            <section id="breadcrumb" class="hoc clear"> 
                <h1><b>Lista Perfiles</b></h1>
            </section>
        </div>
        <div class="wrapper row3" align="center">
            <main class="hoc container clear"> 
                <!-- main body -->
                &nbsp;<input type="submit" class="btn" onclick="location.href='/Veterinaria/Perfil/crearPerfil.jsp'" value="+ nuevo"/>
                <br>
                </br>
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <table border="1">
                            ...
                            <jsp:useBean class="daoImpl.PerfilDAOImp" id="perfilDAO"></jsp:useBean>
                            <c:forEach items="${perfilDAO.listarPerfil()}" var="perfil">
                                <tr>
                                    <td>${perfil.idPerfil}</td>
                                    <td>${perfil.descripcionPerfil}</td>
                                    <td align="center">
                                        <form id="especialidad" action="/Veterinaria/EliminarPerfil" method="POST">
                                            <input type="hidden" name="btnEliminar" value="${perfil.idPerfil}"> 

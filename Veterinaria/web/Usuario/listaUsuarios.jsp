    ...
    <c:if test="${mensaje!=null}">
        ...
        <div class="wrapper row3" align="center">
            <main class="hoc container clear"> 
                <!-- main body -->
                &nbsp;<input type="submit" class="btn" onclick="location.href = '/Veterinaria/Usuario/crearUsuarioAdmin.jsp'" value="+ nuevo"/>
                <br>
                </br>
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <table border="1">
                            ...
                            <jsp:useBean class="daoImpl.UsuarioDAOImp" id="usuDAO"></jsp:useBean>
                            <c:forEach items="${usuDAO.listarUsuarios()}" var="usu">
                                <tr>
                                    ...
                                    <td>${usu.perfilidPerfil}</td>
                                    <td>
                                        <form id="veterinario" action="/Veterinaria/EliminarUsuario" method="POST">
                                            <input type="hidden" name="btnEliminar" value="${usu.rutUsuario}"> 

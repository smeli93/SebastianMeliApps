...
<ul class="clear">
    ...
    <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
        <section id="breadcrumb" class="hoc clear"> 
            <h1 align="center"><b>Mi Perfil</b></h1>
        </section>
    </div>
                                ...
                                <br>
                                    <table border="0">
                                        <tbody   align="center">
                                            <tr>
                                                <td>Rut</td>
                                                <td><label align="center">${dto.rutUsuario}</label></td>
                                            </tr>
                                            <tr>
                                                <td>Nombre</td>
                                                <td><label align="center">${dto.nombreUsuario}</label></td>
                                            </tr>
                                            <tr>
                                                <td>Apellido</td>
                                                <td><label align="center">${dto.apellidoUsuario}</label></td>
                                            </tr>
                                            <tr>
                                                <td>Email</td>
                                                <td><label align="center">${dto.emailUsuario}</label></td>
                                            </tr>
                                            <tr>
                                                <td>Telefono</td>
                                                <td><label align="center">${dto.telefonoUsuario}</label></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody >                                           
                                            <trx>
                                                <td align="right" style="border:hidden;">
                                                    <form action="/Veterinaria/MisMascotas" method="POST">
                                                        <input type="hidden" name="txtMascota" value="${dto.rutUsuario}"/>
                                                        <input name="btnEnviar" class="btn" type="submit" value="Mis Mascotas"/>
                                                    </form>
                                                </td>
                                                        <td align="left">
                                                    <form action="/Veterinaria/MisReservas" method="POST">
                                                        <input type="hidden" name="txtReserva" value="${dto.rutUsuario}"/>
                                                        <input name="btnEnviar" class="btn" type="submit" value="Mis Reservas"/>
                                                    </form>                                                 
                                                </td>
                                            </tr>
                                        </tbody>

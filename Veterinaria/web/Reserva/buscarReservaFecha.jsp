...
<%@page import="daoImpl.ReservaDAOImp"%>
    ...
    <body>
        ...
        <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
            <section id="breadcrumb" class="hoc clear"> 
                <h1><b>Buscar Reserva Por Fecha</b></h1>
            </section>
        </div>
        ...
        <div class="scrollable" align="center">
            <form action="/Veterinaria/BuscarPorFecha" method="POST">
                <table border="0" style="width: 350px; height: 30px; text-align: center; border:hidden;">
                    <tbody >
                        <tr >
                            <td style="border:hidden;"> <h2>FECHA</h2></td>
                            <td style="border:hidden;">
                                <input style="width: 200px; height: 30px;" type="date" name="txtFecha" value="" required="Seleccione una fecha"/>
                            </td>
                            <td>
                                <input style="padding-left: 8px; padding-right: 8px; padding-bottom: 5px; padding-top: 5px;" class="btn" type="submit" value="Buscar" />
                            </td>
                        </tr>
                    </tbody>
                </table>
                        ...
                        <table>
                            ...
                            <tbody align="center">
                                ...
                                <tr>
                                    <td><%= dto.getIdReserva()%></td>
                                    <td><%= dto.getMotivoReserva()%></td>
                                    <td><%= dto.getFechaReserva()%></td>
                                    <td><%= dto.getHoraReserva()%></td>
                                    <td><%= dto.getUsuariorutusuario()%></td>
                                    <td><%= dto.getMascotaidMascota()%></td>
                                </tr>
                                <% } %>
                            </tbody>
                        </table>

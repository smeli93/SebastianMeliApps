...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        ...
        <title>Crear Tipo Mascota</title>
        <meta charset="utf-8"/>
...
<!-- informacion superior -->
        ...
        <div class="wrapper bgded overlay" style="background-image:url('/Veterinaria/resources/images/demo/backgrounds/fondo.png');">
            <section id="breadcrumb" class="hoc clear"> 
                <h1><b>Nuevo Tipo de Mascota</b></h1>
            </section>
        </div>
            ...
            <main class="hoc container clear"> 
                ...
                <div class="content" align="center"> 
                    ...
                    <div class="scrollable" align="center">
                        <form action="/Veterinaria/CrearTipoMascota" method="POST">

                            <table border="0">
                                <tbody>

                                    <tr>
                                        <td align="right"><label>Nombre Tipo Mascota</label></td>
                                        <td><input type="text" size="25" name="txtTipoMascota" value="" placeholder="Nombre del Tipo de Mascota" required/></td>
                                    </tr>
                                </tbody>
                            </table>
                            <br>
